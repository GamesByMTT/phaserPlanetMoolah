...
export default class Disconnection extends Scene{
    ...
    create(){
        ...
        const disconnectionText = this.add.text( this.popupBackground.x, this.popupBackground.y - 70, "Unable to connect to server", {color: "#000000", fontFamily:"Anton", fontSize: '65px', stroke: "#4f3130",
